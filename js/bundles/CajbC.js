...
var CajbC = function (_Component) {
  _inherits(CajbC, _Component);

  function CajbC() {
    _classCallCheck(this, CajbC);

    return _possibleConstructorReturn(this, (CajbC.__proto__ || Object.getPrototypeOf(CajbC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CajbC, _step_2Soy2.default);

exports.default = CajbC;
...
exports.templates = exports.CajbC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CajbC.
   * @public
   */

  goog.module('CajbC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CajbC.render';
  }
...
_metalSoy2.default.register(CajbC, templates);
exports.CajbC = CajbC;
