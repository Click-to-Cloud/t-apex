...
var oEDzK = function (_Component) {
  _inherits(oEDzK, _Component);

  function oEDzK() {
    _classCallCheck(this, oEDzK);

    return _possibleConstructorReturn(this, (oEDzK.__proto__ || Object.getPrototypeOf(oEDzK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(oEDzK, _indexSoy2.default);

exports.default = oEDzK;
...
exports.templates = exports.oEDzK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace oEDzK.
   * @public
   */

  goog.module('oEDzK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'oEDzK.render';
  }
...
_metalSoy2.default.register(oEDzK, templates);
exports.oEDzK = oEDzK;
