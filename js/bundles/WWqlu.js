...
var WWqlu = function (_Component) {
  _inherits(WWqlu, _Component);

  function WWqlu() {
    _classCallCheck(this, WWqlu);

    return _possibleConstructorReturn(this, (WWqlu.__proto__ || Object.getPrototypeOf(WWqlu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WWqlu, _step_1Soy2.default);

exports.default = WWqlu;
...
exports.templates = exports.WWqlu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WWqlu.
   * @public
   */

  goog.module('WWqlu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WWqlu.render';
  }
...
_metalSoy2.default.register(WWqlu, templates);
exports.WWqlu = WWqlu;
