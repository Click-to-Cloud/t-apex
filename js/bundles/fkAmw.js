...
var fkAmw = function (_Component) {
  _inherits(fkAmw, _Component);

  function fkAmw() {
    _classCallCheck(this, fkAmw);

    return _possibleConstructorReturn(this, (fkAmw.__proto__ || Object.getPrototypeOf(fkAmw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fkAmw, _indexSoy2.default);

exports.default = fkAmw;
...
exports.templates = exports.fkAmw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fkAmw.
   * @public
   */

  goog.module('fkAmw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fkAmw.render';
  }
...
_metalSoy2.default.register(fkAmw, templates);
exports.fkAmw = fkAmw;
