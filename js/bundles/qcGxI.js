...
var qcGxI = function (_Component) {
  _inherits(qcGxI, _Component);

  function qcGxI() {
    _classCallCheck(this, qcGxI);

    return _possibleConstructorReturn(this, (qcGxI.__proto__ || Object.getPrototypeOf(qcGxI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qcGxI, _verificationSoy2.default);

exports.default = qcGxI;
...
exports.templates = exports.qcGxI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qcGxI.
   * @public
   */

  goog.module('qcGxI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qcGxI.render';
  }
...
_metalSoy2.default.register(qcGxI, templates);
exports.qcGxI = qcGxI;
