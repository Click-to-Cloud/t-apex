...
var nKOMy = function (_Component) {
  _inherits(nKOMy, _Component);

  function nKOMy() {
    _classCallCheck(this, nKOMy);

    return _possibleConstructorReturn(this, (nKOMy.__proto__ || Object.getPrototypeOf(nKOMy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nKOMy, _creationSoy2.default);

exports.default = nKOMy;
...
exports.templates = exports.nKOMy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nKOMy.
   * @public
   */

  goog.module('nKOMy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nKOMy.render';
  }
...
_metalSoy2.default.register(nKOMy, templates);
exports.nKOMy = nKOMy;
