...
var UnzWN = function (_Component) {
  _inherits(UnzWN, _Component);

  function UnzWN() {
    _classCallCheck(this, UnzWN);

    return _possibleConstructorReturn(this, (UnzWN.__proto__ || Object.getPrototypeOf(UnzWN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UnzWN, _indexSoy2.default);

exports.default = UnzWN;
...
exports.templates = exports.UnzWN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UnzWN.
   * @public
   */

  goog.module('UnzWN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UnzWN.render';
  }
...
_metalSoy2.default.register(UnzWN, templates);
exports.UnzWN = UnzWN;
