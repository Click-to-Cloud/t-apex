...
var GKUHN = function (_Component) {
  _inherits(GKUHN, _Component);

  function GKUHN() {
    _classCallCheck(this, GKUHN);

    return _possibleConstructorReturn(this, (GKUHN.__proto__ || Object.getPrototypeOf(GKUHN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GKUHN, _step_4Soy2.default);

exports.default = GKUHN;
...
exports.templates = exports.GKUHN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GKUHN.
   * @public
   */

  goog.module('GKUHN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GKUHN.render';
  }
...
_metalSoy2.default.register(GKUHN, templates);
exports.GKUHN = GKUHN;
