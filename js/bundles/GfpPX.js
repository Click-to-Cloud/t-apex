...
var GfpPX = function (_Component) {
  _inherits(GfpPX, _Component);

  function GfpPX() {
    _classCallCheck(this, GfpPX);

    return _possibleConstructorReturn(this, (GfpPX.__proto__ || Object.getPrototypeOf(GfpPX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GfpPX, _indexSoy2.default);

exports.default = GfpPX;
...
exports.templates = exports.GfpPX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GfpPX.
   * @public
   */

  goog.module('GfpPX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GfpPX.render';
  }
...
_metalSoy2.default.register(GfpPX, templates);
exports.GfpPX = GfpPX;
