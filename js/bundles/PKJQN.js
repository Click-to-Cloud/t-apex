...
var _creationSoy = __webpack_require__(285);
...
var PKJQN = function (_Component) {
  _inherits(PKJQN, _Component);

  function PKJQN() {
    _classCallCheck(this, PKJQN);

    return _possibleConstructorReturn(this, (PKJQN.__proto__ || Object.getPrototypeOf(PKJQN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PKJQN, _creationSoy2.default);

exports.default = PKJQN;
...
exports.templates = exports.PKJQN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PKJQN.
   * @public
   */

  goog.module('PKJQN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PKJQN.render';
  }
...
_metalSoy2.default.register(PKJQN, templates);
exports.PKJQN = PKJQN;
