...
var VYpbS = function (_Component) {
  _inherits(VYpbS, _Component);

  function VYpbS() {
    _classCallCheck(this, VYpbS);

    return _possibleConstructorReturn(this, (VYpbS.__proto__ || Object.getPrototypeOf(VYpbS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VYpbS, _step_2Soy2.default);

exports.default = VYpbS;
...
exports.templates = exports.VYpbS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VYpbS.
   * @public
   */

  goog.module('VYpbS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VYpbS.render';
  }
...
_metalSoy2.default.register(VYpbS, templates);
exports.VYpbS = VYpbS;
