...
var _predicatesSoy = __webpack_require__(277);
...
var mqNph = function (_Component) {
  _inherits(mqNph, _Component);

  function mqNph() {
    _classCallCheck(this, mqNph);

    return _possibleConstructorReturn(this, (mqNph.__proto__ || Object.getPrototypeOf(mqNph)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mqNph, _predicatesSoy2.default);

exports.default = mqNph;
...
exports.templates = exports.mqNph = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mqNph.
   * @public
   */

  goog.module('mqNph.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mqNph.render';
  }
...
_metalSoy2.default.register(mqNph, templates);
exports.mqNph = mqNph;
