...
var HavyZ = function (_Component) {
  _inherits(HavyZ, _Component);

  function HavyZ() {
    _classCallCheck(this, HavyZ);

    return _possibleConstructorReturn(this, (HavyZ.__proto__ || Object.getPrototypeOf(HavyZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HavyZ, _step_4Soy2.default);

exports.default = HavyZ;
...
exports.templates = exports.HavyZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HavyZ.
   * @public
   */

  goog.module('HavyZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HavyZ.render';
  }
...
_metalSoy2.default.register(HavyZ, templates);
exports.HavyZ = HavyZ;
