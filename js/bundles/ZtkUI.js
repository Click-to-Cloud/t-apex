...
var ZtkUI = function (_Component) {
  _inherits(ZtkUI, _Component);

  function ZtkUI() {
    _classCallCheck(this, ZtkUI);

    return _possibleConstructorReturn(this, (ZtkUI.__proto__ || Object.getPrototypeOf(ZtkUI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZtkUI, _step_1Soy2.default);

exports.default = ZtkUI;
...
exports.templates = exports.ZtkUI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZtkUI.
   * @public
   */

  goog.module('ZtkUI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZtkUI.render';
  }
...
_metalSoy2.default.register(ZtkUI, templates);
exports.ZtkUI = ZtkUI;
