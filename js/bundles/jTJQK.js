...
var jTJQK = function (_Component) {
  _inherits(jTJQK, _Component);

  function jTJQK() {
    _classCallCheck(this, jTJQK);

    return _possibleConstructorReturn(this, (jTJQK.__proto__ || Object.getPrototypeOf(jTJQK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jTJQK, _behaviorSoy2.default);

exports.default = jTJQK;
...
exports.templates = exports.jTJQK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jTJQK.
   * @public
   */

  goog.module('jTJQK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jTJQK.render';
  }
...
_metalSoy2.default.register(jTJQK, templates);
exports.jTJQK = jTJQK;
