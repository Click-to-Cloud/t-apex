...
var AQsjg = function (_Component) {
  _inherits(AQsjg, _Component);

  function AQsjg() {
    _classCallCheck(this, AQsjg);

    return _possibleConstructorReturn(this, (AQsjg.__proto__ || Object.getPrototypeOf(AQsjg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AQsjg, _indexSoy2.default);

exports.default = AQsjg;
...
exports.templates = exports.AQsjg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AQsjg.
   * @public
   */

  goog.module('AQsjg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AQsjg.render';
  }
...
_metalSoy2.default.register(AQsjg, templates);
exports.AQsjg = AQsjg;
