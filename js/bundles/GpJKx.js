...
var GpJKx = function (_Component) {
  _inherits(GpJKx, _Component);

  function GpJKx() {
    _classCallCheck(this, GpJKx);

    return _possibleConstructorReturn(this, (GpJKx.__proto__ || Object.getPrototypeOf(GpJKx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GpJKx, _indexSoy2.default);

exports.default = GpJKx;
...
exports.templates = exports.GpJKx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GpJKx.
   * @public
   */

  goog.module('GpJKx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GpJKx.render';
  }
...
_metalSoy2.default.register(GpJKx, templates);
exports.GpJKx = GpJKx;
