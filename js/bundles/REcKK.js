...
var REcKK = function (_Component) {
  _inherits(REcKK, _Component);

  function REcKK() {
    _classCallCheck(this, REcKK);

    return _possibleConstructorReturn(this, (REcKK.__proto__ || Object.getPrototypeOf(REcKK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(REcKK, _predicatesSoy2.default);

exports.default = REcKK;
...
exports.templates = exports.REcKK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace REcKK.
   * @public
   */

  goog.module('REcKK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'REcKK.render';
  }
...
_metalSoy2.default.register(REcKK, templates);
exports.REcKK = REcKK;
